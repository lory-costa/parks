...
export default function Filter () {
  return(
    <div className='flex absolute inset-x-0.5 top-28 ml-20 z-20'>
      ...
      <FilterItem facilityIcon={<img src='/icons/toilets.png' alt="toilet icon" width="35" height="35"/>} facilityValue={'toilets'} />
      ...
      <FilterItem facilityIcon={<img src='/icons/tramp.png' alt="tramp walking icon" width="35" height="35"/>} facilityValue={'tramp'} />
