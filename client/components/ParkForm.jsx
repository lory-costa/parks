...
export default function ParkForm(props) {
  ...
  const [color, setColor] = useState(
    "bg-gray-700 hover:bg-gray-500 text-white py-2 px-4 rounded focus:outline-green-500"
  );
  const [upload, setUpload] = useState("Upload Photo");
  const [image, setImage] = useState(
    (props.formData && props.formData.image) || ""
  );
  ...
  function handleSubmit(e) {
    ...
    if (results.isValid) {
      ...
      alert("Park submitted for approval");
    } else {
      ...
      <form className='flex flex-col md:flex-row'>
        <div className='sm:w-full lg:w-1/3 lg:mr-16'>
          ...
          <div className='mt-4'>
            ...
            />
            {invalid.address && (
              <div className='text-red-500'>{invalid.address}</div>
            )}
          </div>
          ...
          <div className='mt-4'>
            ...
            />
            {invalid.description && (
              <div className='text-red-500'>{invalid.description}</div>
            )}
          </div>
        ...
        {isAdmin && (
          <div className='flex flex-row justify-between items-center'>
            <div>
              {approved ? (
                <img
                  src='/icons/activeMarker.gif'
                  alt='Active Park'
                  width='20'
                />
              ) : (
                <img
                  src='/icons/dormantMarker.png'
                  alt='Dormant Park'
                  width='20'
                />
              )}
