...
function Facilities (props) {
  ...
  return (
    <div>
      ...
      {picnic && <img src='/icons/picnic-area.svg' alt="picnic icon" width="50" height="50"/> }
      {sports && <img src='/icons/icons-sports.svg' alt="sports icon" width="50" height="50"/> }
      {tramp && <img src='/icons/icon-walking.svg' alt="tramp walking icon" width="50" height="50"/>}

      {!dogs ? <img src='/icons/dogAllowed.png' alt="dog allowed icon" width="50" height="50"/> : <img src='/icons/dogNotAllowed.png' alt="dog not
      allowed icon" width="50" height="50"/>}
